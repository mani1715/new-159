...
1. Navigate to: `https://dev-playground-54.preview.emergentagent.com/client/login`
...
3. **Check Network Tab** (F12 → Network tab)
   - All requests should be to `https://dev-playground-54.preview.emergentagent.com/api/...`
   - ❌ No requests should use `http://` protocol

#### C. Verify Data Syncing
1. Keep client dashboard open
2. In another tab, open admin panel: `https://dev-playground-54.preview.emergentagent.com/admin/login`
...
#### A. Home Page
1. Navigate to: `https://dev-playground-54.preview.emergentagent.com/`
...
```
[API Config] Base URL constructed: https://dev-playground-54.preview.emergentagent.com/api
[API Request] GET /client/projects Base: https://dev-playground-54.preview.emergentagent.com/api
[API Request] POST /admin/clients Base: https://dev-playground-54.preview.emergentagent.com/api
```
...
### Client Login
- URL: `https://dev-playground-54.preview.emergentagent.com/client/login`
