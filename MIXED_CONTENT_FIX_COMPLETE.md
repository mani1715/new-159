...
- Frontend was loaded over **HTTPS** (https://secure-datapath.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://secure-datapath.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://secure-datapath.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://secure-datapath.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://secure-datapath.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://secure-datapath.preview.emergentagent.com
- Admin Panel: https://secure-datapath.preview.emergentagent.com/admin/login
