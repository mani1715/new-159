...
1. **User loads page**: `https://dev-code-central.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://dev-code-central.preview.emergentagent.com/api/client/projects`
...
When you access: `https://dev-code-central.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://dev-code-central.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://dev-code-central.preview.emergentagent.com` (production)
