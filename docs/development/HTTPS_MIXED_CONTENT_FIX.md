...
### Error Message
```
Mixed Content: The page at 'https://dev-code-central.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://dev-code-central.preview.emergentagent.com`): Uses `/api` → converted to `https://dev-code-central.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://dev-code-central.preview.emergentagent.com,https://dev-code-central.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://dev-code-central.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://dev-code-central.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://dev-code-central.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://dev-code-central.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://dev-code-central.preview.emergentagent.com`
