...
### The Specific Error:
```
Mixed Content: The page at 'https://dev-code-central.preview.emergentagent.com/client/dashboard' 
...
1. **Frontend page loads** over HTTPS: `https://dev-code-central.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://dev-code-central.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://dev-code-central.preview.emergentagent.com/client/dashboard`
