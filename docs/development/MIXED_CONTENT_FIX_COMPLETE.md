...
- Frontend was loaded over **HTTPS** (https://dev-toolkit-45.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://dev-toolkit-45.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://dev-toolkit-45.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://dev-toolkit-45.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://dev-toolkit-45.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://dev-toolkit-45.preview.emergentagent.com
- Admin Panel: https://dev-toolkit-45.preview.emergentagent.com/admin/login
