...
- Frontend was loaded over **HTTPS** (https://dev-code-central.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://dev-code-central.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://dev-code-central.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://dev-code-central.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://dev-code-central.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://dev-code-central.preview.emergentagent.com
- Admin Panel: https://dev-code-central.preview.emergentagent.com/admin/login
