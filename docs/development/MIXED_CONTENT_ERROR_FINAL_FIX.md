...
```
Mixed Content: The page at 'https://dev-toolkit-45.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://dev-toolkit-45.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://dev-toolkit-45.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://dev-toolkit-45.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://dev-toolkit-45.preview.emergentagent.com/api/client/projects \
