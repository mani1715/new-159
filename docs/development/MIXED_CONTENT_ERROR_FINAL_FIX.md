...
```
Mixed Content: The page at 'https://feature-hub-18.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://feature-hub-18.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://feature-hub-18.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://feature-hub-18.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://feature-hub-18.preview.emergentagent.com/api/client/projects \
