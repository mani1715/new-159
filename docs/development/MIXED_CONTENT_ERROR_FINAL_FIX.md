...
✅ **Production (HTTPS)**: API calls use `https://dev-code-central.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://dev-code-central.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://dev-code-central.preview.emergentagent.com/api/client/projects \
