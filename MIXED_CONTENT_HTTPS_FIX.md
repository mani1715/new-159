...
- **Page URL**: `https://dev-playground-54.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Error Message
```
Mixed Content: The page at 'https://dev-playground-54.preview.emergentagent.com/client/dashboard' 
...
### Production (HTTPS)
- Page loads at: `https://dev-playground-54.preview.emergentagent.com`
- API calls go to: `https://dev-playground-54.preview.emergentagent.com/api`
