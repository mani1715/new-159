...
- **Page loaded over**: `https://network-debug-3.preview.emergentagent.com/client/dashboard`
...
DB_NAME=mspn_dev_db
CORS_ORIGINS=https://network-debug-3.preview.emergentagent.com,http://localhost:3000
