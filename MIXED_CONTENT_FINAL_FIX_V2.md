...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://network-debug-3.preview.emergentagent.com/api"
...
// Returns: "https://network-debug-3.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://network-debug-3.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://network-debug-3.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://network-debug-3.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://network-debug-3.preview.emergentagent.com/api
...
- Go to: `https://network-debug-3.preview.emergentagent.com/client/dashboard`
- Login if needed
