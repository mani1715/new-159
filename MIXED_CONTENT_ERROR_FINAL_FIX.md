...
✅ **Production (HTTPS)**: API calls use `https://network-debug-3.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://network-debug-3.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://network-debug-3.preview.emergentagent.com/api/client/projects \
