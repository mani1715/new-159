...
### Error Message
```
Mixed Content: The page at 'https://secure-datapath.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://secure-datapath.preview.emergentagent.com`): Uses `/api` → converted to `https://secure-datapath.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://secure-datapath.preview.emergentagent.com,https://secure-datapath.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://secure-datapath.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://secure-datapath.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://secure-datapath.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://secure-datapath.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://secure-datapath.preview.emergentagent.com`
